...
import { getQuestion, listQuestions, listOptions } from 'src/graphql/queries';
...
export const useQuestions = getQueryHook(getAllQuestions);

// ================================

export function getAllOptions() {
  return callGraphQL<ListOptionsQuery>({
    query: listOptions,
    variables: {
      limit: 100,
    },
